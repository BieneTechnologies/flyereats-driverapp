...
function TaskDetailsChevron_1(data )
{
	...
	var html='';
	html+='<ons-list-item tappable onclick="openTaskMap('+data.task_id+', '+ "'" +data.task_lat +"'" +', '+ "'" +data.task_lng +"'" +', '+ "'" + data.delivery_address + "'" + ' )"  >';
...
function TaskDetailsChevron_4(data )
{
	...
	var html='';
	html+='<ons-list-item tappable onclick="openTaskMap('+data.task_id+', '+ "'" +data.merchant_lat +"'" +', '+ "'" +data.merchant_lng +"'" +', '+ "'" + data.merchant_address + "'" + ' )"  >';
     html+='<ons-col width="90%" >     ';
         html+='<div class="table">';
             html+='<div class="col a">';
             html+='<ons-icon icon="ion-location" size="20px"></ons-icon>';
